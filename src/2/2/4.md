...
![コンテンツの更新を知らせるポップアップの良い例。コンテンツを更新する「アップデート」と書かれたボタンと、コンテンツの更新を延期できる「あとで更新」のボタンが表示されている。ポップアップを閉じるボタンが示されている。]({{ site.dir }}/img//2/2/4/2.2.4_ok.svg)
<figcaption>
{% include "partials/good.njk" %}
ポップアップを閉じて、コンテンツの更新を延期できる。</figcaption>
</figure>
</li>
<li>
<figure>

![コンテンツの更新を知らせるポップアップの悪い例。コンテンツの最新のバーションへの更新に対し「OK」のボタンのみ表示されている。]({{ site.dir }}/img//2/2/4/2.2.4_ng.svg)
<figcaption>
{% include "partials/bad.njk" %}
コンテンツの更新以外に選択肢がなく、ポップアップを閉じることができない。ユーザーはこれまでの操作を中断することになり、正しく操作を完了できなくなる恐れがある。</figcaption>
</figure>
</li>
</ul>
