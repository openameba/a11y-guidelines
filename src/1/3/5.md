...
```html
<label for="form-address">市区町村を入力</label>
<input type="text" name="address" autocomplete="address" id="form-address" placeholder="市区町村">
```

<img src="/img/1/3/5/autocomplete.png" width="420" height="296" alt="「し」の値が入力され、候補に品川区・渋谷区・新宿区・杉並区・世田谷区が表示されている入力欄" class="image">
