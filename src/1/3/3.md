...
<figure>
<img src="/img/1/3/3/1.3.3_ng.png" alt="お名前とニックネームを入力するフォーム。入力が完了したら右下のボタンを押して下さい。というテキストの下に「前へ」「次へ」ボタンが表示されている。" />
<figcaption>
{% label "bad" %}
...
<figure>
<img src="/img/1/3/3/1.3.3_ok.png" alt="お名前とニックネームを入力するフォーム。入力が完了したら右下の「次へ」ボタンを押して下さい。というテキストの下に「前へ」「次へ」ボタンが表示されている。" />
<figcaption>
{% label "good" %}
フォームの「次へ」ボタンを位置が判断できるラベル付きで説明している。
{% endlabel %}
</figcaption>
</figure>
