...
<figure>
<img src="/img/1/3/3/1.3.3_ng_01.svg" alt="お名前とニックネームを入力するフォームが表示されている。必須項目であるお名前は文字色が赤色で表現されている。" />
<figcaption>
{% label "bad" %}
...
<figure>
<img src="/img/1/3/3/1.3.3_ok.svg" alt="お名前（必須）とニックネームを入力するフォームが表示されている。" />
<figcaption>
{% label "good" %}
...
<li>
<figure>
<img src="/img/1/3/3/1.3.3_ok_02.svg" alt="お名前（必須）とニックネームを入力するフォームが表示されている。必須項目であるお名前は文字色が太字かつ赤色で表現されている。" />
<figcaption>
{% label "good" %}
