...
- [1.3.5 入力目的を特定できる](/a11y-guidelines/1/3/5)<span class="Label">AAA</span>
...
- [2.3.3 ユーザー操作で起きるアニメーションを無効にできる](/a11y-guidelines/2/3/3)<span class="Label">AAA</span>
...
- [2.5.4 動きによる操作以外でも操作を可能にする](/a11y-guidelines/2/5/4)<span class="Label">A</span>
